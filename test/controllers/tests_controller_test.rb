...
class TestsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create test" do
    assert_difference('Test.count') do
      post tests_url, params: { test: { test1: @test.test1, test2: @test.test2, test3: @test.test3 } }
    end
  ...
  test "should update test" do
    patch test_url(@test), params: { test: { test1: @test.test1, test2: @test.test2, test3: @test.test3 } }
